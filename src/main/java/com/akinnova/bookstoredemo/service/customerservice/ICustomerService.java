...
public interface ICustomerService {
    ResponsePojo<CustomerResponseDto> createCustomer(CustomerDto customerDto);
    ...
    ResponsePojo<CustomerResponseDto> updateCustomer(CustomerUpdateDto updateCustomerDto);
